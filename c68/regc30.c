 ...
 */
static REG parameter_registers[] = {REG_R0, REG_R1, REG_R2, REG_AR0, REG_AR1};
 ...
 *      saved.
 */
static REG saved_registers[] = {REG_R3, REG_R4, REG_R5, REG_R6, REG_R7, REG_AR2, REG_AR3, REG_AR4, REG_AR5, REG_AR6, REG_AR7};
 ...
 */
static REG result_registers[] = {REG_R0};
 ...
 * returns TRUE if an address register is available at ,,no cost'' (no push).
 */
BOOL is_free_ireg P0(void) { return (reg_in_use[next_index] == UNUSED); }
