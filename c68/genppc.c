 ...
 */
static ADDRESS *g_expr P2(const EXPR *, ep, FLAGS, flags) { return NIL_ADDRESS; }
...
struct genfuncs powerpc_funcs = {g_expression, g_jtrue,     g_jfalse,     g_stack,      g_switch_table, g_switch_compare,
                                 ...
                                 g_order,      g_transform, g_initialize, g_terminate,  g_regusage,     &alignments_ppc[0]};
