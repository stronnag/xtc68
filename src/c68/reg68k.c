 ...
 */
static REG parameter_registers[] = {D0, D1, D2, A0, A1};
 ...
 */
static REG result_registers[] = {D0, D1, D2};
...
static ADDRESS apush = {am_adec, STACKPTR, (REG)0, EMPTY, {NIL_EXPR}};
static ADDRESS apop = {am_ainc, STACKPTR, (REG)0, EMPTY, {NIL_EXPR}};
