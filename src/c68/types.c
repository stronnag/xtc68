...
static RANGE range_schar = {-128L, 127L};
static RANGE range_short = {-32768L, 32767L};
static RANGE range_long = {-2147483647L - 1L, 2147483647L};
static RANGE range_uchar = {0L, (IVAL)OxffUL};
static RANGE range_ushort = {0L, (IVAL)OxffffUL};
static RANGE range_ulong = {0L, (IVAL)OxffffffffUL};

/*****************************************************************************/

static FUNC func_params = {&init_block, (REGUSAGE *)0};

/*****************************************************************************/

static TYP stp_void = {bt_void, QUAL_NONE, STATE_NONE, UNKNOWN_SIZE, NIL_TYP, NIL_TYP, (const CHAR *)"void", {NIL_RANGE}};

static TYP stp_long = {bt_long, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"long", {&range_long}};

static TYP stp_ulong = {bt_ulong, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"unsigned long", {&range_ulong}};

static TYP stp_char = {bt_char, QUAL_NONE, STATE_NONE, 1L, NIL_TYP, NIL_TYP, (const CHAR *)"char", {&range_schar}};

static TYP stp_uchar = {bt_uchar, QUAL_NONE, STATE_NONE, 1L, NIL_TYP, NIL_TYP, (const CHAR *)"unsigned char", {&range_uchar}};

static TYP stp_schar = {bt_schar, QUAL_NONE, STATE_NONE, 1L, NIL_TYP, NIL_TYP, (const CHAR *)"signed char", {&range_schar}};

static TYP stp_short = {bt_short, QUAL_NONE, STATE_NONE, 2L, NIL_TYP, NIL_TYP, (const CHAR *)"short", {&range_short}};

static TYP stp_ushort = {bt_ushort,      QUAL_NONE, STATE_NONE, 2L, NIL_TYP, NIL_TYP, (const CHAR *)"unsigned short",
                         {&range_ushort}};

static TYP stp_int = {bt_int32, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"int", {&range_long}};

static TYP stp_uint = {bt_uint32, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"unsigned int", {&range_ulong}};

#ifdef FLOAT_MFFP
static TYP stp_float = {bt_float, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"float", {NIL_RANGE}};

static TYP stp_double = {bt_double, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"double", {NIL_RANGE}};

static TYP stp_longdouble = {bt_longdouble, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"long double",
                             {NIL_RANGE}};

#else
static TYP stp_float = {bt_float, QUAL_NONE, STATE_NONE, 4L, NIL_TYP, NIL_TYP, (const CHAR *)"float", {NIL_RANGE}};

static TYP stp_double = {bt_double, QUAL_NONE, STATE_NONE, 8L, NIL_TYP, NIL_TYP, (const CHAR *)"double", {NIL_RANGE}};

static TYP stp_longdouble = {bt_longdouble, QUAL_NONE, STATE_NONE, 12L, NIL_TYP, NIL_TYP, (const CHAR *)"long double",
                             {NIL_RANGE}};

#endif /* FLOAT_MFFP */
static TYP stp_string = {bt_pointer32, QUAL_NONE, STATE_DERIVED, 4L, &stp_char, NIL_TYP, (const CHAR *)"pointer to char",
                         {NIL_RANGE}};

static TYP stp_func = {
    bt_func, QUAL_NONE, STATE_DERIVED, 4L, &stp_int, NIL_TYP, (const CHAR *)"function", {(RANGE *)&func_params}};

static TYP stp_struct = {bt_struct, QUAL_NONE, STATE_NONE, UNKNOWN_SIZE, NIL_TYP, NIL_TYP, (const CHAR *)"struct", {NIL_RANGE}};

static TYP stp_union = {bt_union, QUAL_NONE, STATE_NONE, UNKNOWN_SIZE, NIL_TYP, NIL_TYP, (const CHAR *)"union", {NIL_RANGE}};

static TYP stp_pointer = {bt_pointer32, QUAL_NONE, STATE_NONE, 4L, &stp_void, NIL_TYP, (const CHAR *)"pointer", {NIL_RANGE}};

static TYP stp_array = {bt_pointer32, QUAL_NONE, STATE_DERIVED,         UNKNOWN_SIZE,
                        NIL_TYP,      NIL_TYP,   (const CHAR *)"array", {NIL_RANGE}};

static TYP stp_enum = {bt_int32, QUAL_NONE, STATE_NONE, UNKNOWN_SIZE, NIL_TYP, NIL_TYP, (const CHAR *)"int", {NIL_RANGE}};

static TYP stp_ellipsis = {bt_ellipsis, QUAL_NONE, STATE_NONE,          UNKNOWN_SIZE,
                           NIL_TYP,     NIL_TYP,   (const CHAR *)"...", {NIL_RANGE}};
...
BOOL is_function_type P1(const TYP *, tp) {
  ...
  return (is_func(tp)) || (is_pointer_type(tp) && is_func(referenced_type(tp)));
}
 ...
 */
BOOL is_scalar_type P1(const TYP *, tp) { return (is_arithmetic_type(tp) || is_pointer_type(tp) || is_bitfield_type(tp)); }
...
BOOL is_array_type P1(const TYP *, tp) { return (is_pointer_type(tp) && is_derived_type(tp)); }
...
BOOL is_equal_type P2(const TYP *, tp1, const TYP *, tp2) {
  ...
  case bt_func:
    return is_equal_type(returned_type(tp1), returned_type(tp2)) && is_equal_proto(parametersof(tp1), parametersof(tp2));
  case bt_struct:
  case bt_union:
...
TYP *composite_type P2(TYP *, tp1, TYP *, tp2) {
  ...
  case bt_pointer32:
     ...
     */
    set_referenced_type(tp1, composite_type(referenced_type(tp1), referenced_type(tp2)));
  ...
  case bt_func:
     ...
     */
    set_returned_type(tp1, composite_type(returned_type(tp1), returned_type(tp2)));
...
BOOL is_compatible_type P2(const TYP *, tp1, const TYP *, tp2) {
  ...
  case bt_func:
    return is_compatible_type(returned_type(tp1), returned_type(tp2)) && is_compatible_proto(parameters(tp1), parameters(tp2));
  case bt_struct:
  case bt_union:
    return (members(tp1) == members(tp2));
  default:
...
static unsigned hash P1(const TYP *, tp) { return ((uintptr_t)tp >> (unsigned)2 & (MAXKEY - (unsigned)1)); }
...
BOOL is_subtype P2(const TYP *, tp1, const TYP *, tp2) {
  if (is_integral_type(tp1) && is_integral_type(tp2)) {
    ...
    return (is_constant_in_type_range(rp->low, tp2, tp1) && is_constant_in_type_range(rp->high, tp2, tp1));
  }
  return FALSE;
}
...
TYP *mk_type P2(const TYP *, tp1, TYP *, btp) {
  ...
  case bt_pointer32:
    for (tp = hashtable[keyno]; tp; tp = nexttyp(tp)) {
      ...
      if (is_same_type(tp, tp1) && (tp->qual == tp1->qual) && is_same_size(tp, tp1) && (tp->btp == btp) &&
          (is_enum(tp) == is_enum(tp1)) && (is_derived_type(tp) == is_derived_type(tp1))) {
        return tp;
      }
    }
    break;
...
void size_type P1(TYP *, tp) {
  ...
  if (is_array_type(tp)) {
    ...
    size_type(rtp);
    if (rtp != NIL_TYP && (array_index(tp) != UNKNOWN_SIZE) && (!is_unknown_size(rtp))) {
