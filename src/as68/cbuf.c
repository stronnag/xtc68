...
CLIST *t_head = (CLIST *)NULL, *d_head = (CLIST *)NULL;
CLIST *txtptr = (CLIST *)NULL, *datptr = (CLIST *)NULL;
...
CBUF *generate(short n, short act, long val, SYM *psym) {
