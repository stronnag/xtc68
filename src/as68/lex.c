 ...
 */
#ifdef MINIX
    {".align", _ALIGN, 0},  {".ascii", _DC, 8},   {".asciz", _ASCII, 0},
#endif
    {".bss", _BSS, 0},      {".comm", _COMM, 0},  {".data", _DATA, 0},
#ifdef MINIX
    {".data1", _DC, 8},     {".data2", _DC, 16},  {".data4", _DC, 32},
#endif
    {".dc", _DC, 0},
#ifdef MINIX
    {".define", _GLOBL, 0},
#endif
    {".ds", _DS, 0},        {".end", END, 0},     {".equ", _EQU, 0},     {".even", _EVEN, 0},
#ifdef MINIX
    {".extern", _GLOBL, 0},
#endif
    {".globl", _GLOBL, 0},  {".long", _DC, 32},   {".org", _ORG, 0},
#ifdef MINIX
    {".rom", _DATA, 0},     {".sect", _SECT, 0},  {".space", _DS, 8},
#endif
    {".text", _TEXT, 0},    {"a0", REG, 8},       {"a1", REG, 9},        {"a2", REG, 10},     {"a3", REG, 11},
    {"a4", REG, 12},        {"a5", REG, 13},      {"a6", REG, 14},       {"a7", REG, 15},     {"bss", _BSS, 0},
    {"ccr", SREG, O_CCR},   {"comm", _COMM, 0},   {"d0", REG, 0},        {"d1", REG, 1},      {"d2", REG, 2},
    {"d3", REG, 3},         {"d4", REG, 4},       {"d5", REG, 5},        {"d6", REG, 6},      {"d7", REG, 7},
    {"data", _DATA, 0},     {"dc", _DC, 0},       {"ds", _DS, 0},        {"end", END, 0},     {"equ", _EQU, 0},
    {"even", _EVEN, 0},     {"globl", _GLOBL, 0}, {"org", _ORG, 0},      {"pc", PC, 0},       {"sp", REG, 15},
    {"sr", SREG, O_SR},     {"text", _TEXT, 0},   {"usp", SREG, O_USP},  {"", 0, 0}};
